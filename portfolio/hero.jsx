...
function CineHero() {
  return (
    <div style={{
      position: 'relative', minHeight: 900, overflow: 'hidden',
      background: 'radial-gradient(ellipse at 72% 42%, #1d1410 0%, #0a0a0c 58%)',
    }}>
      <CineNav />

      {/* concentric VR rings with slow rotation */}
      ...
      {/* content */}
      <div style={{
        position: 'relative', zIndex: 2, padding: '180px 56px 120px',
        maxWidth: 1100,
      }}>
        <div style={{
          ...
          Now playing &nbsp;·&nbsp; Gameplay programmer, available April 2026
        </div>
        <h1 style={{
          fontFamily: cine.display, fontWeight: 500, fontSize: 148,
          lineHeight: 0.9, letterSpacing: -5, margin: '0 0 40px',
        }}>
          Build<br/>worlds that<br/>
          <span style={{ color: cine.accent }}>react.</span>
        </h1>
        <div style={{
          fontFamily: cine.body, fontSize: 19, lineHeight: 1.55,
          color: cine.ink2, maxWidth: 620, marginBottom: 56,
        }}>
          ...
          netcode, and physics: the unglamorous backbone that makes game feel feel real.
        </div>
      ...
      <div style={{
        ...
        {[
          ...
          <div key={k} style={{
            ...
            <div style={{ fontFamily: cine.display, fontSize: 22, color: cine.ink, fontWeight: 500 }}>{v}</div>
          </div>
        ))}
      </div>
